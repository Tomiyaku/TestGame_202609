...
namespace CodeIcf.Extensions
{
    ...
    public static class ScrollRectExtensions
    {
        ...
        public static bool ScrollToBottom( this ScrollRect _scrollRect, GameObject _obj, out float _scrollValue )
        {
            return ScrollToCore( _scrollRect, _obj, 0f, out _scrollValue );
        }
        ...
        /// <param name="_scrollRect"></param>
        /// <param name="_obj"></param>
        public static bool ScrollToTop( this ScrollRect _scrollRect, GameObject _obj, out float _scrollValue )
        {
            return ScrollToCore( _scrollRect, _obj, 1f, out _scrollValue );
        }
        ...
        /// <param name="_scrollRect"></param>
        /// <param name="_obj"></param>
        public static bool ScrollToCentering( this ScrollRect _scrollRect, GameObject _obj, out float _scrollValue )
        {
            return ScrollToCore( _scrollRect, _obj, 0.5f, out _scrollValue );
        }
        ...
        public static bool ScrollToCentering( this ScrollRect _scrollRect, RectTransform _targetRect, out float _scrollValue )
        {
            return ScrollToCore( _scrollRect, _targetRect, 0.5f, out _scrollValue );
        }
        ...
        /// <returns></returns>
        public static bool ScrollToCore( this ScrollRect _scrollRect, GameObject _obj, float _align, out float _scrollValue )
        {
            return ScrollToCore( _scrollRect, _obj.GetComponent<RectTransform>(), _align, out _scrollValue );
        }
        ...
        /// <param name="_align">0:下、0.5:中央、1:上</param>
        /// <returns></returns>
        public static bool ScrollToCore( this ScrollRect _scrollRect, RectTransform _targetRect, float _align, out float _scrollValue )
        {
            _scrollValue = 0;
            ...
            _scrollValue = Mathf.Clamp01( normalizedPos );

            return false;
        }

        public static bool ScrollHorizontalToCore( this ScrollRect _scrollRect, RectTransform _targetRect, float _align, out float _scrollValue )
        {
            _scrollValue = 0;
