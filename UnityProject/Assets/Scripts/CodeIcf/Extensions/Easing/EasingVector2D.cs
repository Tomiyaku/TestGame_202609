...
namespace CodeIcf.Extensions.Easing
{
    ...
    /// Vector2用イージング関数
    /// </summary>
    public static class EasingVector2D
    {
        public static Vector2 GetNowValue( EasingType _type, float _nowTime, float _totalTime, Vector2 _min, Vector2 _max )
        {
            switch( _type )
            {
        ...
        public static Vector2 QuadIn( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime;
        ...
        public static Vector2 QuadOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime;
        ...
        public static Vector2 QuadInOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime / 2;
        ...
        public static Vector2 CubicIn( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime;
        ...
        public static Vector2 CubicOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
        ...
        public static Vector2 CubicInOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime / 2;
        ...
        public static Vector2 QuartIn( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime;
        ...
        public static Vector2 QuartOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time = _time / _totaltime - 1;
        ...
        public static Vector2 QuartInOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime / 2;
        ...
        public static Vector2 QuintIn( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime;
        ...
        public static Vector2 QuintOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time = _time / _totaltime - 1;
        ...
        public static Vector2 QuintInOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime / 2;
        ...
        public static Vector2 SineIn( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
        ...
        public static Vector2 SineOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
        ...
        public static Vector2 SineInOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
        ...
        public static Vector2 ExpIn( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
        ...
        public static Vector2 ExpOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
        ...
        public static Vector2 ExpInOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
        ...
        public static Vector2 CircIn( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime;
        ...
        public static Vector2 CircOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time = _time / _totaltime - 1;
        ...
        public static Vector2 CircInOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime / 2;
        ...
        //public static Vector2 BackIn( float _time, float _totaltime, Vector2 _min, Vector2 _max, float _s )
        //{
        //    _max -= _min;
        //    _time /= _totaltime;
        ...
        //public static Vector2 BackOut( float _time, float _totaltime, Vector2 _min, Vector2 _max, float _s )
        //{
        //    _max -= _min;
        //    _time = _time / _totaltime - 1;
        ...
        //public static Vector2 BackInOut( float _time, float _totaltime, Vector2 _min, Vector2 _max, float _s )
        //{
        //    _max -= _min;
        //    _s *= 1.525f;
        //    _time /= _totaltime / 2;
        ...
        public static Vector2 BounceIn( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;

            return _max - BounceOut( _totaltime - _time, _totaltime, new Vector2(), _max ) + _min;
        }

        public static Vector2 BounceOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            _max -= _min;
            _time /= _totaltime;
        ...
        public static Vector2 BounceInOut( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
            if( _time < _totaltime / 2 )
            {
                return BounceIn( _time * 2, _totaltime, new Vector2(), _max - _min ) * 0.5f + _min;
            }
            else
            {
                return BounceOut( _time * 2 - _totaltime, _totaltime, new Vector2(), _max - _min ) * 0.5f + _min + ( _max - _min ) * 0.5f;
            }
        }

        public static Vector2 Linear( float _time, float _totaltime, Vector2 _min, Vector2 _max )
        {
