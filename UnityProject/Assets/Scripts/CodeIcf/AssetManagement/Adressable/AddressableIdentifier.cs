...
namespace CodeIcf.AssetManagement.AdressableManagement
{
    ...
    public class AddressableIdentifier 
    {
        ...
        public static void DivideIdentifier( uint _identifier, out AddressableCategory _category, out uint _index )
        {
            _category = ConvertCategoty( _identifier );
            _index = _identifier & ~( AssetCommonDefine.IDENTIFIER_FLAG_RANGE + AssetCommonDefine.IDENTIFER_CATEGORY_RANGE );
        }
    }
