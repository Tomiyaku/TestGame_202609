...
namespace CodeIcf.Extensions
{
    ...
    public static class GameObjectExtension
    {
        ...
        /// <summary>
        /// 自身と全ての子オブジェクトのレイヤーを変更する
        /// </summary>
        /// <param name="_self">対象のGameObject</param>
        /// <param name="_layer">レイヤーID</param>
        public static void SetLayerToAllChildObject( this GameObject _self, int _layer )
        {
            _self.layer = _layer;

            foreach( Transform child in _self.transform )
            {
                SetLayerToAllChildObject( child.gameObject, _layer );
            }
        }
    }
}