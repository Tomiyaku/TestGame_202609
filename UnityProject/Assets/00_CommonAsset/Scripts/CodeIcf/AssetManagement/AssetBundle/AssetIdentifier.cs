...
namespace CodeIcf.AssetManagement.AssetBundleManagement
{
    ...
    public class AssetIdentifier
    {
        ...
        public static void DivideIdentifier( uint _identifier, out AssetBundleCategory _outCategory, out uint _outIndex )
        {
            _outCategory = ConvertCategoty( _identifier );
            _outIndex = _identifier - ( _outCategory.ToUint() << AssetCommonDefine.INDEX_BIT_SIZE );
        }
    }
