...
namespace CodeIcf.Input.GamePad
{
    ...
    /// ゲームパッドのキーのリピート入力判定
    /// </summary>
    public class GamePadKeyRepeatChecker
    {
        /// <summary>
        /// キー毎のリピート入力判定
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public GamePadKeyRepeatChecker()
        {
        ...
        private int ConvertIndex( GamepadKeyId _keyId )
        {
            switch( _keyId )
            {
                ...
                case GamepadKeyId.LT: return KeyList.ZL.ToInt();
                case GamepadKeyId.RT: return KeyList.ZR.ToInt();
                ...
                case GamepadKeyId.Start: return KeyList.Plus.ToInt();
                case GamepadKeyId.Select: return KeyList.Minus.ToInt();
            }
